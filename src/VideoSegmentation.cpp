...
VideoSegmentation::VideoSegmentation(): scale_for_propagation_(0),
starting_scale_(2),scales_(3),gpu_(0),threshold_(0.06), segmentation_1(nullptr)
, segmentation_2(nullptr),representation_1(nullptr),representation_2(nullptr)
,prefix_1_("./nodemats"),prefix_2_("./nodemats"){
	// TODO Auto-generated constructor stub

}

VideoSegmentation::VideoSegmentation(int scale_for_propagation, int starting_scale, int scales, int gpu,
 double thres): scale_for_propagation_(scale_for_propagation),
starting_scale_(starting_scale),scales_(scales),gpu_(gpu),threshold_(thres), segmentation_1(nullptr)
, segmentation_2(nullptr),representation_1(nullptr),representation_2(nullptr)
,prefix_1_("./nodemats"),prefix_2_("./nodemats"){
	// TODO Auto-generated constructor stub
...
void VideoSegmentation::init(int scale_for_propagation, int starting_scale, int scales, int gpu,
 double thres){
...
void VideoSegmentation::addImage(Mat& src, Mat& dst) {
	...
	if(representation_1 == nullptr){
		...
		dst = segmentation_1->getOutputSegmentsPyramid()[scale_for_propagation_];
